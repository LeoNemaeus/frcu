...
begin 			{**principal**}
	...
	repeat
		...
		writeln('	3: ver cantidad de varones aprobados');
		writeln('	4: ver porcentaje mujeres con nota = 10');
		writeln('	5: ver porcentaje desaprobados');
        op := readkey;
		...
		case op of
			...
			'3': begin
                    writeln('');
                    writeln('cantidad de varones aprobados: ', varones_aprobados(v));
                 end;
			'4': begin
                 writeln('');
                 writeln('porcentaje mujeres con nota = 10: ', mujeres_excelente(v):3:1);
             end;
			'5': begin
                 writeln('');
                   writeln('porcentaje desaprobados: ', desaprobados(v):3:1);
                   end;
             #27: run := false;
        end;
	until run = false;
